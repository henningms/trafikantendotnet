...
{
    public class GetDeparturesAdvancedQueryBuilder : GetArrivalsAdvancedQueryBuilder
    {
        public GetDeparturesAdvancedQueryBuilder()
        {
            
        }

        public GetDeparturesAdvancedQueryBuilder(int placeId, String time, List<String> lines, List<String> transporttypes)
        {
            PlaceId = placeId;
            Time = time;
            Lines = lines;
        ...
        public new void BuildUrl()
        {
            ...
            var url = ApiPaths.ApiUrl + ApiPaths.Travelstage.GetDeparturesAdvanced;
